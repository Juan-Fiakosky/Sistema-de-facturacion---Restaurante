...
def guardar():
    ...
    archivo = filedialog.askopenfile(mode="w", defaultextension=".txt")
...
aplicacion.geometry("1280x500+0+0")
...
# Panel costos
panel_costos = Frame(panel_izquierdo, bd=1, relief=FLAT, bg="azure4", padx=45)
...
# Lista de productos
lista_comidas = ["pollo", "sushi", "merluza", "panchos", "lomito", "pizza", "ravioles", "fideos"]
lista_bebidas = ["agua", "soda", "cerveza", "vino1", "coca", "vino2", "limonada", "fernet"]
lista_postres = ["helado", "ensalada", "frutas", "torta", "budin", "flan", "panqueques", "cheesecake"]
